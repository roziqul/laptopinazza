            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="breadcrumb-text">
                        <p>Latest Model and 100% Original Product</p>
                        <h1>Cart</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="logo-carousel-inner">
                        ...
                        <div class="single-logo-item">
                            <img src="assets/img/company-logos/7.jpg" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="assets/img/company-logos/8.jpg" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="assets/img/company-logos/9.jpg" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="assets/img/company-logos/10.jpg" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="assets/img/company-logos/11.jpg" alt="">
                        </div>
                        <div class="single-logo-item">
